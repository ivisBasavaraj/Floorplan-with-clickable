  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Exhibition Floor Plan on Map */}
        <Route path="/exhibition-map" element={<ExhibitionMapDemo />} />
        
        {/* Enhanced Leaflet Map with Canvas Layer */}
        <Route path="/enhanced-map" element={<EnhancedMapDemo />} />
